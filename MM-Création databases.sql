...
CREATE TABLE Objet(ido SMALLINT AUTO_INCREMENT,lostBy SMALLINT, foundBy SMALLINT, nom CHAR(15),description CHAR(30), date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE Lieu(idl SMALLINT AUTO_INCREMENT, tag CHAR(15), lat DECIMAL(10,7), lng DECIMAL(10,7)
